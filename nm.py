    ...
    while True:
        ...
        if FrameID == 0xFF:
            ...
            or  checksum != prev_checksum
                ...
                INFO(f"Parsed header message: File length: {data_len} B | Checksum: {checksum.hex()} | Number of frames: {num_of_frames}")


        if is_reading_frames and (FrameID < len(slots)):
...
def main(nrf: NRF24, node_id: str, is_first_node: bool) -> None:
    ...
    all_channels = sorted(TAN0_CHANNELS + TAN1_CHANNELS + TBN0_CHANNELS + TBN1_CHANNELS)
