...
# :::: CLASS METHODS ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    ...
    def send_DATA_message(self: "CustomNRF24", DATA_MESSAGE: bytes, PageID: int, ChunkID: int) -> None:
        """
        ...
        while not message_has_been_sent:
            ...
            try:
                ...
                ERROR(f"Time-out while sending DATA message {PageID}|{ChunkID}, retrying")
                packets_lost += 1
                continue
